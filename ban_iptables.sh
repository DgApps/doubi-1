...
#       Version: 1.0.10
#       Blog: https://doubioBackup.github.io/doub.io/shell-jc2/
#=================================================
...
Update_Shell(){
	sh_new_ver=$(wget --no-check-certificate -qO- -t1 -T3 "https://raw.githubusercontent.com/doubioBackup/doubi/master/ban_iptables.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1)
	[[ -z ${sh_new_ver} ]] && echo -e "${Error} 无法链接到 Github !" && exit 0
	wget -N --no-check-certificate "https://raw.githubusercontent.com/doubioBackup/doubi/master/ban_iptables.sh" && chmod +x ban_iptables.sh
...
echo && echo -e " iptables防火墙 封禁管理脚本 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
  -- Toyo | doubioBackup.github.io/doub.io/shell-jc2 --
